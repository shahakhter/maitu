  ...
  initApp() {
    ...
    this.platform.ready().then(() => {
      ...
      this.platform.backButton.subscribeWithPriority(10, (processNextHandler) => {
        ...
        if (this._location.isCurrentPathEqualTo('/tabs/tab1') || this._location.isCurrentPathEqualTo('/tabs/tab2') || this._location.isCurrentPathEqualTo('/tabs/tab3') || this._location.isCurrentPathEqualTo('/tabs/notifications')) {
